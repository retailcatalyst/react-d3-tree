...
var Tree = /** @class */ (function (_super) {
    ...
    Tree.prototype.componentDidUpdate = function (prevProps) {
        if (this.props.data !== prevProps.data) {
            if (this.state.isInitialRenderForDataset) {
                ...
                this.setState({
                    data: Tree.assignInternalProperties((0, clone_1.default)(this.props.data), undefined, this.state.data[0]),
                });
            }
        }
     ...
     * @static
     */
    Tree.assignInternalProperties = function (data, currentDepth, prevDataState) {
    ...
    Tree.getNodeProps = function (node, nodeKey) {
        if (node.key === nodeKey) {
            return node;
        }
        else {
            if (node.children) {
                for (var _i = 0, _a = node.children; _i < _a.length; _i++) {
                    var child = _a[_i];
                    var result = Tree.getNodeProps(child, nodeKey);
                    if (result) {
                        return result;
                    }
                }
